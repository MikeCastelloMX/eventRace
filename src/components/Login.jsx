...
function Login() {
  return (
    <div className="kt-login-v1--enabled kt-quick-panel--right kt-demo-panel--right kt-offcanvas-panel--right kt-header--static kt-header-mobile--fixed kt-subheader--enabled kt-subheader--transparent kt-aside--enabled kt-aside--fixed kt-page--loading">
      <div style= {{ backgroundImage: 'url(./assets/media/misc/bg_1.jpg)' }}/>
